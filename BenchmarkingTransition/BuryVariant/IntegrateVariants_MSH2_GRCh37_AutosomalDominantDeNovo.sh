...
WORKING_DIR=$PWD/${GENE}_${GENOME}_${INHERITANCE}
mkdir -p $WORKING_DIR
...
MERGED_GB_VCF=$PWD/../../Examples/${GENE}_${GENOME}_${INHERITANCE}.vcf

# Proband
IN_PROBAND_GB_VCFA=${MERGED_GB_VCF::-4}.proband.vcf
IN_PROBAND_BACKGROUND_VCFGZ=$PWD/Polaris_VCF/ERR2304597_DeepVariant0.8.noRefCalls.vcf.gz
IN_PROBAND_BACKGROUND_VCF=$PWD/Polaris_VCF/ERR2304597_DeepVariant0.8.noRefCalls.vcf
PROBAND_COVERAGE=45

# Mother
IN_MOTHER_GB_VCFA=${MERGED_GB_VCF::-4}.mother.vcf
IN_MOTHER_BACKGROUND_VCFGZ=$PWD/Polaris_VCF/ERR1955491_DeepVariant0.8.noRefCalls.vcf.gz
IN_MOTHER_BACKGROUND_VCF=$PWD/Polaris_VCF/ERR1955491_DeepVariant0.8.noRefCalls.vcf
MOTHER_COVERAGE=45

# Father
IN_FATHER_GB_VCFA=${MERGED_GB_VCF::-4}.father.vcf
IN_FATHER_BACKGROUND_VCFGZ=$PWD/Polaris_VCF/ERR1955404_DeepVariant0.8.noRefCalls.vcf.gz
IN_FATHER_BACKGROUND_VCF=$PWD/Polaris_VCF/ERR1955404_DeepVariant0.8.noRefCalls.vcf
FATHER_COVERAGE=45

...
function STR(props) {
  const [url, setUrl] = useState('http://127.0.0.1:5001/get_str/' + props.genome + '/' + props.gene_uid + '/' + props.region);
  ...
  useEffect(() => {
    ...
    function onRegionChange() {
      if (props.region === "CUSTOM") {
        ...
        setUrl('http://127.0.0.1:5001/get_str/' + props.genome + '/' + props.gene_uid + '/' + region)
      } else {
        setUrl('http://127.0.0.1:5001/get_str/' + props.genome + '/' + props.gene_uid + '/' + props.region)
      }
    }
